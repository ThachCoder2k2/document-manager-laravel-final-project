                        ...
                        @foreach($documents as $document)
                            ...
                            <tr>
                                ...
                                <td style="display:flex;" >
                                    ...
                                    data-visibility="{{ $document['visibility'] }}">Sửa</button>
                                    <form style="margin-left:10px;" method="post" action="{{route('admin.delete_document')}} ">
                                        @csrf
    ...
    <div class="modal" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{route('admin.edit_document')}}" method="post">
                    @csrf
                    <!-- Modal Header -->
